...
public class DatabaseConfig {
    ...
    /**
     * Getter untuk database password (digunakan untuk testing)
     */
    ...
    /**
     * Getter untuk database driver (digunakan untuk testing)
     */
    ...
    /**
     * Getter untuk properties (digunakan untuk testing)
     */
    public static Properties getProperties() {
        return new Properties(properties); // Return copy untuk safety
    }
}